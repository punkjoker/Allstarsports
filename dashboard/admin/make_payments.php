...
<head>
   ...
   <body class="page-body  page-fade" onload="collapseSidebar()">
    ...
    <td height="35">
        ...
        <!-- Checkout button for M-Pesa -->
        <button class="a1-btn a1-green" onclick="checkoutMpesa()">Checkout M-Pesa</button>
		<script>
    function checkoutMpesa() {
        window.location.href = 'mpesa-checkout.php';
    }
</script>
